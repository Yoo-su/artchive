  ...
  return (
    <div className="relative flex items-center shrink-0">
      <button
        type="button"
        onClick={toggleModal}
        className={`group relative flex h-8.5 w-21 items-center justify-between rounded-full border px-2.5 whitespace-nowrap shrink-0 transition-all duration-200 ${
          isPlaying
