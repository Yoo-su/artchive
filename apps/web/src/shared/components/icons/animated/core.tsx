...
type AnimatedIconProps<T> = DefaultIconProps<T> &
  Omit<SVGMotionProps<SVGSVGElement>, "animate"> & {
    size?: number | string;
  };

type IconWrapperProps<T> = AnimatedIconProps<T> & {
  icon: React.ComponentType<AnimatedIconProps<T>>;
};
