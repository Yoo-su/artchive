 ...
 */
export const CalendarDays = ({ className, size = 24, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    />{" "}
    <path
      d="M20.75 18.3496H3.25C2.84 18.3496 2.5 18.0096 2.5 17.5996C2.5 17.1896 2.84 16.8496 3.25 16.8496H20.75C21.16 16.8496 21.5 17.1896 21.5 17.5996C21.5 18.0096 21.16 18.3496 20.75 18.3496Z"
      fill="currentColor"
    />{" "}
    <path
