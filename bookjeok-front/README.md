...
- **🤖 AI 도서 요약 & 취향 탐색기 (AI Recommendation)**
  - **AI 도서 요약**: 책 상세 페이지에서 AI가 생성한 핵심 요약 및 추천 대상 정보를 제공합니다.
  - **너굴잎 취향 탐색기 (Taste Finder)**:
    - 귀여운 AI 사서 '너굴잎'과 대화하며 나만의 인생 책을 찾을 수 있습니다.
    - **인터랙티브 채팅 UI**: RAG-lite 기반의 정확한 추천과 함께, 타자기 효과(Typewriter Effect) 등 감성적인 로딩 경험을 제공합니다.
    - **가입 유도 (Teaser)**: 비로그인 사용자에게는 추천 결과를 흐릿하게(Blur) 보여주어 자연스럽게 가입을 유도합니다.
