...
export const FullScreenLoader = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen bg-linear-to-b from-stone-50 via-white to-stone-50/50 fixed inset-0 z-999 overflow-hidden">
