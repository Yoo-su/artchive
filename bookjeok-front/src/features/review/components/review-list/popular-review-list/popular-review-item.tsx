...
export function PopularReviewItem({ review }: PopularReviewItemProps) {
  ...
  return (
    <Card
      className="h-full flex flex-col hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border-stone-200 overflow-hidden group bg-white"
      ...
      <CardContent className="px-5 py-4 grow flex flex-col">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-stone-100/50">
          <div className="flex items-center gap-2.5">
            <Avatar className="w-6 h-6 border border-stone-100" data-nosnippet>
              <AvatarImage
